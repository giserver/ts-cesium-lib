...
export default class Weather extends FeatureBase {
    ...
    private currentState: PostProcessStage | undefined;
    ...
    add(type: WeatherType): void {
        ...
        PostProcessStageLibrary.createBrightnessStage().uniforms.brightness = 2;

        // 开启后期处理
        scene.postProcessStages.add(this.currentState);
    ...
    clear(): void {
        ...
        if (this.currentState != undefined)
            collection.remove(this.currentState);
    }
